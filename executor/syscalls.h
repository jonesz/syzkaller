...
const call_t syscalls[] = {
    ...
    {"ioctl$ifreq_SIOCGIFINDEX_wg", 54},
    {"ioctl$int_in", 54},
    {"ioctl$int_out", 54},
    ...
    {"sendmsg$WG_CMD_GET_DEVICE", 370},
    {"sendmsg$WG_CMD_SET_DEVICE", 370},
    {"sendmsg$alg", 370},
    {"sendmsg$can_bcm", 370},
    {"sendmsg$can_raw", 370},
    ...
    {"syz_genetlink_get_family_id$wg", 0, (syscall_t)syz_genetlink_get_family_id},
...
const call_t syscalls[] = {
    ...
    {"ioctl$ifreq_SIOCGIFINDEX_wg", 16},
    {"ioctl$int_in", 16},
    {"ioctl$int_out", 16},
...
const call_t syscalls[] = {
    ...
    {"sendmsg$WG_CMD_GET_DEVICE", 296},
    {"sendmsg$WG_CMD_SET_DEVICE", 296},
    {"sendmsg$alg", 296},
    {"sendmsg$can_bcm", 296},
    {"sendmsg$can_raw", 296},
...
const call_t syscalls[] = {
    ...
    {"ioctl$ifreq_SIOCGIFINDEX_wg", 29},
    {"ioctl$int_in", 29},
    {"ioctl$int_out", 29},
    ...
    {"sendmsg$WG_CMD_GET_DEVICE", 211},
    {"sendmsg$WG_CMD_SET_DEVICE", 211},
    {"sendmsg$alg", 211},
    {"sendmsg$can_bcm", 211},
    {"sendmsg$can_raw", 211},
...
const call_t syscalls[] = {
    ...
    {"sendmsg$WG_CMD_GET_DEVICE", 341},
    {"sendmsg$WG_CMD_SET_DEVICE", 341},
    {"sendmsg$alg", 341},
    {"sendmsg$can_bcm", 341},
    {"sendmsg$can_raw", 341},
